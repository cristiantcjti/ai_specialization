...
with open("./test_output/docling_paper_metadata.jsonl") as f:
    for line in f:
        doc = json.loads(line)
...
metadata_document_info = {"title": paper_title, "url": paper_url}
...
result[0].payload  # noqa: B018
result[0].payload["text"]  # type: ignore
result[0].payload["metadata"]["url"]  # type: ignore
